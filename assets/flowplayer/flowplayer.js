...
(function (e) {
    ...
    var t = !0, n = !1, r = "onreadystatechange", i = "DOMContentLoaded", s = "__IE8__" + Math.random(), o = e.Object, u = o.defineProperty || function (e, t, n) {
            e[t] = n.value
        ...
        }, f = o.getOwnPropertyDescriptor, l = o.prototype.hasOwnProperty, c = e.Element.prototype, h = e.Text.prototype, p = /^[a-z]+$/, d = /loaded|complete/, v = {}, m = document.createElement("div");
    b(e.HTMLCommentElement.prototype, c, "nodeValue"), b(e.HTMLScriptElement.prototype, null, "text"), b(h, null, "nodeValue"), b(e.HTMLTitleElement.prototype, null, "text"), u(e.HTMLStyleElement.prototype, "textContent", function (e) {
        ...
        addEventListener: {
            value: function (e, t, n) {
                var r = this, i = "on" + e, o = r[s] || u(r, s, {value: {}})[s], a = o[i] || (o[i] = {}), f = a.h || (a.h = []), c;
                if (!l.call(a, "w")) {
                    a.w = function (e) {
                            ...
                            setTimeout(function () {
                                try {
                                    if (!api.PercentLoaded()) {
                                        return player.trigger("error", [player, {
                                            code: 7,
                                            url: conf.swf
                                        }]);
                                    }
...
// esc button
        ...
        10: [function (_dereq_, module, exports) {
            ...
            flowplayer(function (api, root) {
                ...
                var speedhelp = flowplayer.support.video && api.conf.engine !== "flash" && !!document.createElement('video').playbackRate ?
                ...
                self.resolve = function (video, sources) {
                    ...
                    if (typeof video == 'string') {
                        ...
                        video.sources = (sources || []).map(function (source) {
                            ...
                            return {
                                type: source.type,
                                src: video.src.replace(TYPE_RE, '.' + suffix + "$2")
                            };
                        });
                    }
...
//Have to add fullscreen last
            ...
            flowplayer(function (e, o) {
                ...
                }, l = e.conf, t = flowplayer.common, i = t.createElement, d = l.swf.indexOf("flowplayer.org") && l.e && o.getAttribute("data-origin"), s = d ? a(d) : t.hostname(), p = (document, l.key);
                "file:" == location.protocol && (s = "localhost"), e.load.ed = 1, l.hostname = s, l.origin = d || location.href, d && n(o, "is-embedded"), "string" == typeof p && (p = p.split(/,\s*/));
                var f = function (e, a) {
                    var n = i("a", {href: a, className: "fp-brand"});
                    n.innerHTML = e, t.find(".fp-controls", o)[0].appendChild(n)
                };
