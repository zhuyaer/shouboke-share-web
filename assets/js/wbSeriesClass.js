...
(function($){
    var Page={
        ...
        //默认链接
        linkUrl:"https://api.weibo.com/oauth2/authorize?client_id=367727881&response_type=code&redirect_uri=http://shouboke.tv/weChat_web_develop/wbSeriesClass.html?state=",
        // linkUrl:"https://api.weibo.com/oauth2/authorize?client_id=367727881&response_type=code&redirect_uri=http://shouboke.tv/shareModel/wbSeriesClass.html?state=",
        /******************生产环境配置END***************/
        ...
        getVideoInfo:function(){
            ...
            $.ajax({
                url: _this.commonUrl+"stream/show?streamId="+streamId+"&type=join&isSeries=true",  //获取视频信息以及权限
                type:"get",
                headers:{
        ...
        bindEvent:function(){
            ...
            $(".liveListTitle .findMore").on('click',function(){
                window.location.href='http://shouboke.tv/webChatPublic/weiboRecommend.html'
            })
        ...
        var url = location.href;
            ...
            function postCode(){//使用code换取access_token
                ...
                $.ajax({
                    ...
                    data: {
                        code: code,
                        url: 'http://shouboke.tv/weChat_web_develop/wbSeriesClass.html?state='+streamId
                    },
                    success: function (data){
                            getUserInfo(data);
                        },
