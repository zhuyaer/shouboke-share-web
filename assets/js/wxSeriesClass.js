...
(function($){
    var Page={
        ...
        // "appid=wx18e63e75d50cb458&redirect_uri=http://shouboke.tv/weChat_web_develop/wxSeriesClass.html&response_type=code&",
        linkBasicUrl:"https://open.weixin.qq.com/connect/oauth2/authorize?"+
        "appid=wx18e63e75d50cb458&redirect_uri=http://shouboke.tv/shareModel/wxSeriesClass.html&response_type=code&",
        //默认链接
        ...
        wxShare:function(data){
            ...
            if(data){
                ...
                var shareData={//分享到朋友
                        ...
                        link: 'http://shouboke.tv/seriesClass/html/seriesTransfer.html?state='+streamId, // 分享链接，默认分享当前页，目前微信分享不支持https格式的链接
                        imgUrl: thumbnailUrl, // 分享图标
                        success: function () {
                ...
                var shareQqData={//分享到qq
                        title: data.status == "ready"?readyModel:data.status == "live"?liveModel:overModel, // 分享标题
                        desc: '分享真知，成长智慧，改变人生', // 分享描述
                        link: 'http://shouboke.tv/shareModel/qqIndex.html?state='+_this.dataObj.streamId,// 分享链接，默认分享当前页，目前微信分享不支持https格式的链接
                        imgUrl: thumbnailUrl, // 分享图标
                        success: function () {
        ...
        bindEvent:function(){
            ...
            $(".liveListTitle .findMore").on('click',function(){
                window.location.href='http://shouboke.tv/webChatPublic/wxRecommend.html'
            })
    ...
    $(function(){
        var url = location.href;
            ...
            function init_to(){
                ...
                if(dataObj&&dataObj.token&&dataObj.apiToken){
                    try{
                        //更新streamId
                        var dataJson={
                            token:dataObj.token,
